...
### AI/ML and Generative AI (LLMs) in the Lab

Our lab uses computational methods, including machine learning, in our
research. We also recognize that generative AI tools (e.g., large language
models/LLMs) can be useful in limited contexts. Our goal is to foster
responsible, ethical, and transparent use that protects research integrity,
...
* **PI guidance supersedes:** Dr. Benjamin's instructions about AI/LLM use for a
  project or role **override** general guidance in this manual.
* **Training/learning (no AI):** When you are learning core skills (coding
  fundamentals, statistics, pipelines, tooling, or lab workflows), do not use
...
* **Projects use:** AI/LLM use is not the default in research projects. If AI is
  ...
  pipeline,” “improve this code,” “make a figure”) is not allowed without
  explicit approval.
* **Coding assistance:** Unless explicitly approved by Dr. Benjamin, AI/LLMs may
  not be used for coding, except for debugging. Debugging means: diagnosing and
  correcting errors in code you already wrote and understand, limited to small,
  isolated snippets tied to a specific error message. Debugging does not include
  generating new code, rewriting/refactoring, optimization, designing workflows,
  feature implementation, or translation between languages.
* **Manuscripts and figures:** Do not use AI/LLMs for manuscript or grant
  writing, or for generating figures/visualizations, unless Dr. Benjamin
  explicitly authorizes a specific narrow use, such as copy editing or
  brainstorming.
* **Disclosure:** Always document when text, code, analyses, or figure elements
  were generated or materially modified using an AI/LLM.
* **Accountability:** Researchers remain fully responsible for all
  AI/LLM-assisted outputs (correctness, originality, citations, and compliance).
* **Privacy/compliance:** Do not enter sensitive, confidential,
  controlled-access, or identifiable data into external AI/LLM services. When in
  doubt, ask first.
* **Privilege:** Permission to use AI/LLMs is a discretionary privilege and may
  be revoked by Dr. Benjamin with or without notice.
